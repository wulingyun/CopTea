...
#' @param randomize The number of samples generated by the randomized rounding strategy, 0 to disable.
...
#'
#' @export
ceat <- function(core.sets, gene.set, method="LP", randomize=1, verbose=1)
{
...
ceat.randomize <- function(solution, core.sets, gene.set, alpha)
{
  N <- dim(core.sets)[1]
  M <- dim(core.sets)[2]
  xx <- solution[1:M]
